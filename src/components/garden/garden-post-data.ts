...
export const gardenPostDetails: Record<string, GardenPostDetail> = {
  "async-error-handling": {
    tagline: "Where I drew the line between silent failures and useful boundaries.",
    blocks: [
      {
        type: "paragraph",
        width: "narrow",
...
export async function wrapAsync<T>(task: () => Promise<T>): Promise<Result<T>> {
    try {
      ...
      },
      {
        ...
        caption: "Keeping the problem visible without turning the page into a log dump.",
      },
      {
        type: "component",
        width: "wide",
  ...
  "pr-template-design": {
    tagline: "A template only works if it improves the handoff between author and reviewer.",
    blocks: [
      {
        type: "paragraph",
        width: "narrow",
      ...
      },
      {
        ...
        caption: "Templates should shorten the distance between intent and review.",
      },
      {
        type: "quote",
        width: "narrow",
  ...
  "service-layer-abstraction": {
    tagline: "Less indirection, more signal, until the edge cases demand a seam.",
    blocks: [
      {
        type: "paragraph",
        width: "narrow",
...
return cached;`,
      },
      {
        ...
        caption: "The old and new shapes need a controlled overlap window.",
      },
    ],
  },
  "scroll-direction-hook": {
    tagline: "A tiny hook that keeps scroll work off the main thread of thought.",
    blocks: [
      {
        type: "paragraph",
        width: "narrow",
...
export function useScrollDirection() {
  ...
  "api-endpoint-checklist": {
    tagline: "A compact list of things that should fail loudly before customers see them.",
    blocks: [
      {
        type: "paragraph",
        width: "narrow",
    ...
    'measure latency and retries',
      ...
      },
      {
        ...
        caption: "An embedded YouTube slot for longer explanations or walkthroughs.",
      },
      {
        type: "quote",
        width: "narrow",
  ...
  "feature-flag-complexity": {
    tagline: "Feature flags are useful when the complexity they buy is strictly temporary.",
    blocks: [
      {
        type: "paragraph",
        width: "narrow",
      ...
      },
      {
        ...
        caption: "Not every branch deserves to become a permanent path.",
      },
      {
        type: "quote",
        width: "narrow",
  ...
  "cold-start-tracing": {
    ...
    blocks: [
      ...
      },
      {
        ...
        caption: "You can swap this block for a real talk or product walkthrough later.",
      },
      {
        type: "component",
        width: "wide",
  ...
  "typed-env-validation": {
    tagline: "Strongly typed config starts with validating the boundary once.",
    blocks: [
      {
        type: "paragraph",
        width: "narrow",
...
export const env = EnvSchema.parse(process.env);`,
  ...
  "note-taking-cadence": {
    tagline: "A writing cadence that keeps the garden live without making the habit heavy.",
    blocks: [
      {
        type: "paragraph",
        width: "narrow",
      ...
      },
      {
        ...
        caption: "The writing system should lower friction, not add ceremony.",
      },
      {
        type: "quote",
        width: "narrow",
