import { ArrowUpRightIcon, LeafIcon, PlantIcon, TreeIcon } from "@phosphor-icons/react";
...
export const STAGE_META: Record<GardenStage, { label: string; className: string }> = {
      ...
      <div className="relative z-10 flex flex-col gap-6">
        <div className="flex flex-col md:items-start md:gap-6 md:flex-row">
          ...
          <div className="flex shrink-0 flex-col gap-2 text-right">
            ...
            <span className="font-mono text-xs text-ink-faint">{entry.lastEdited}</span>
          </div>
        </div>
